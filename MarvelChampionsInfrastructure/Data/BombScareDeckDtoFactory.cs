	...
	public static ICardSet Create() => new CardSet(CardSetId, false, true, false, "Bomb Scare", new List<CollectibleCardDto>()
		{
			...
			new CollectibleCardDto() { Id = EntityId.Create("e2c10ad9-87ad-40be-b3ee-348b16418349"), CardSet = CardSetId, Title = "Hydra Bomber" },
			new CollectibleCardDto() { Id = EntityId.Create("2d58ab8b-ddfb-4d32-9d0a-5f4fd174a059"), CardSet = CardSetId, Title = "Explosion" },
			new CollectibleCardDto() { Id = EntityId.Create("2d835e24-893d-4ff0-85ee-3fc3779551c4"), CardSet = CardSetId, Title = "False Alarm" },
			new CollectibleCardDto() { Id = EntityId.Create("fc558ec9-2d8b-488e-8d6a-6fa314e89e26"), CardSet = CardSetId, Title = "False Alarm" },
		});
}
