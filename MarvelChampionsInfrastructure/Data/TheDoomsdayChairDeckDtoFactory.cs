	...
	public static ICardSet Create() => new CardSet(false, true, "The Doomsday Chair", new List<CollectibleCardDto>()
		{
			...
			new CollectibleCardDto() { Id = EntityId.Create("bde1beb5-bd60-4781-a1bc-ed5e0f50a1a6"), CardSet = CardSetId, Title = "MODOK" },
			new CollectibleCardDto() { Id = EntityId.Create("6a3d99ee-20eb-426e-b601-e2563300705f"), CardSet = CardSetId, Title = "Biomechanical Upgrades" },
			new CollectibleCardDto() { Id = EntityId.Create("a29eae67-2230-4174-ac15-e356af8325fe"), CardSet = CardSetId, Title = "Biomechanical Upgrades" },
			new CollectibleCardDto() { Id = EntityId.Create("1428f325-3d47-430d-9499-09dc599b3913"), CardSet = CardSetId, Title = "Biomechanical Upgrades" },
		});
}
